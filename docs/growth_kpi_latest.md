...
- page_view: **114**
- tg_click: **5** (`4.4%` from page_view)
- tg_start (all entrypoints): **6**
- tg_start from site payloads: **4** (`80.0%` from tg_click)
- watchlist_add events: **2**
- watchlist_add users: **1** (`16.7%` from all tg_start)
- watchlist_add users from site-attributed starts: **1** (`25.0%` from site-attributed tg_start)
...
- users_with_watchlist_add proxy (`bot.watchlist`): **2**
- start_to_watchlist_add proxy: **100.0%**
...
|---|---:|---:|
| site_en | 3 | 50.0% |
| site_en_sticky | 1 | 16.7% |
| telegram_direct | 1 | 16.7% |
| upgrade | 1 | 16.7% |
